...
namespace GoogleARCore.Examples.Common {
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour {
        ...
        public void Awake() {
            ...
            m_childCollider = this.gameObject.transform.GetChild(0).GetComponent<MeshCollider>();
        ...
        public void Update() {
            ...
            if (PointcloudVisualizer.Instance.GetActiveRenderer()) {
                m_MeshRenderer.enabled = true;
            } else {
                m_MeshRenderer.enabled = false;
            }
        ...
        public void Initialize(DetectedPlane plane) {
            ...
            m_MeshRenderer.material.SetFloat("_UvRotation", UnityEngine.Random.Range(0.0f, 360.0f));
        ...
        private void _UpdateMeshIfNeeded() {
            ...
            m_planeNormal = m_DetectedPlane.CenterPose.rotation * Vector3.up;
            ...
            m_childCollider.sharedMesh = m_Mesh;

            //if (Time.frameCount % interval == 0)
            PointCloudVisualizer.CheckCurrentPointsWithNewPlane(this);
            //else Debug.Log("Checked Planes was not performed");
        }
        ...
        public MeshCollider GetChildCollider() { return m_childCollider;  }
    }
}
